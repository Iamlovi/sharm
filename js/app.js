...
(() => {
  ...
  function w(e = {}, t = {}) {
    Object.keys(t).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = t[s])
        : b(t[s]) && b(e[s]) && Object.keys(t[s]).length > 0 && w(e[s], t[s]);
    });
  }
  const S = {
    body: {},
  ...
  const A = {
    ...
    hasClass: function (...e) {
      const t = L(e.map((e) => e.split(" ")));
      return (
        I(this, (e) => t.filter((t) => e.classList.contains(t)).length > 0)
          .length > 0
      );
    },
  ...
  const Y = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ("auto" === i.slidesPerView) {
            ...
            if (
              ...
              x = e.isHorizontal() ? l.outerWidth(!0) : l.outerHeight(!0);
            else {
              const e = s(a, "width"),
                t = s(a, "padding-left"),
                i = s(a, "padding-right"),
      ...
      if (
        ...
        G(e.wrapperEl, "--swiper-centered-offset-before", -h[0] + "px"),
          G(
            e.wrapperEl,
  ...
  const Z = {
    loopCreate: function () {
      ...
      for (let e = 0; e < r.length; e += 1)
        n.append(M(r[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = l.length - 1; e >= 0; e -= 1)
  ...
  function ee(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? p >= l[e] && p < l[e + t] && ((h = e), (u = l[e + t] - l[e]))
        : p >= l[e] && ((h = e), (u = l[l.length - 1] - l[l.length - 2]));
    }
    const g = (p - l[h]) / u,
  ...
  function we({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function d() {
      ...
      if (
        ("fraction" === s.type &&
          (d.find(be(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          d.find(be(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let t;
    ...
    Te(),
      document.querySelector(".staff-slider") &&
        new fe(".staff-slider", {
          ...
          breakpoints: {
            320: { slidesPerView: 1.6, spaceBetween: 20, autoHeight: !0 },
      ...
      document.querySelector(".courses-slider") &&
        new fe(".courses-slider", {
          ...
          navigation: {
            nextEl: ".courses-slider__next",
            prevEl: ".courses-slider__prev",
          },
          breakpoints: {
            320: {
              slidesPerView: 1.2,
      ...
      return (
        (e.prototype.generateSettings = function (e) {
          if (
            ...
            var t = Oe(
              Oe({}, this.settings.mobileSettings),
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (a = Pe(t, this.outer, r, o, this.currentImageSize))),
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              a.LGel.trigger(Qe, { index: t, delay: s || 0, isFirstSlide: n });
          }, r);
        }),
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          v && !ke(document.body).hasClass("lg-from-hash") && (T = v),
            ...
            (this.isFirstSlideWithZoomAnimation() &&
              ...
              this.onLgObjectLoad(n, e, v, T, f, !(!u || !u.html5 || a)),
            (this.zoomFromOrigin && this.currentImageSize) ||
          ...
          this.settings.enableDrag &&
            ...
            ke(window).on("mouseup.lg.global" + this.lgId, function (a) {
              if (e.lgOpened) {
                var l = ke(a.target);
                n
                  ? ((n = !1), e.touchEnd(s, t, a), e.LGel.trigger(nt))
                  : e.isPosterElement(l) && e.LGel.trigger(tt),
                  i &&
                    ((i = !1),
        ...
        (e.prototype.goToPrevSlide = function (e) {
          ...
          e && this.galleryItems.length < 3 && (s = !1),
            this.lgBusy ||
              (this.index > 0
                ? (this.index--,
                  this.LGel.trigger(lt, { index: this.index, fromTouch: e }),
      ...
      i &&
        i.addEventListener(
          ...
          function (t) {
            e.paused
              ? (e.play(),
                e.parentElement.classList.add("playing"),
                e.parentElement.classList.remove("paused"))
              : (e.pause(),
                e.parentElement.classList.remove("playing"),
                e.parentElement.classList.add("paused"),
  ...
  for (let e = 0; e < ut.length; e++)
    mt == ut[e].href && ut[e].classList.add("active-menu");
  for (let e = 0; e < gt.length; e++)
    mt == gt[e].href && gt[e].classList.add("active-menu");
  const ft = document.documentElement;
  document.addEventListener("click", function (e) {
    !e.target.closest(".header__menu") &&
      innerWidth < 992 &&
      (ft.classList.remove("menu-open"), ft.classList.remove("lock"));
  }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
        ...
        e.forEach((e) => {
          ...
          e.querySelectorAll("[data-tabs-item]").forEach((a, l) => {
            t.matches
              ? (n.append(i[l]),
                n.append(a),
                e.classList.toggle("_tab-spoller"))
